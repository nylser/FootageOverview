...
urlpatterns = [
    ...
    path('cam/<int:camera_id>/<int:year>/<int:month>/', views.month_view, name='month_view'),
    path('cam/<int:camera_id>/<int:year>/<int:month>/<int:day>/', views.day_view, name='day_view'),
]
